...
import { X, Shield, BookOpen, Briefcase, Activity, AlertTriangle } from 'lucide-react';
...
const UserDetailsModalContent = ({ selectedUser, closeModal }) => {
...
const UserDetailsModal = () => {
  ...
  return <UserDetailsModalContent key={selectedUser.id} selectedUser={selectedUser} closeModal={closeModal} />;
};
